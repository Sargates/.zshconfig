...
green=$'\e[38;2;13;188;121m'
yellow=$'\e[38;2;229;229;16m'
blue=$'\e[38;2;36;114;200m'
magenta=$'\e[38;2;188;63;188m'
cyan=$'\e[38;2;17;168;205m'
white=$'\e[38;2;229;229;229m'
light_black=$'\e[38;2;102;102;102m'
light_red=$'\e[38;2;241;76;76m'
light_green=$'\e[38;2;35;209;139m'
light_yellow=$'\e[38;2;245;245;67m'
light_blue=$'\e[38;2;59;142;234m'
light_magenta=$'\e[38;2;214;112;214m'
light_cyan=$'\e[38;2;41;184;219m'
light_white=$'\e[38;2;229;229;229m'

# Background color aliases
black_back=$'\e[48;2;0;0;0m'
red_back=$'\e[48;2;205;49;49m'
green_back=$'\e[48;2;13;188;121m'
yellow_back=$'\e[48;2;229;229;16m'
blue_back=$'\e[48;2;36;114;200m'
magenta_back=$'\e[48;2;188;63;188m'
cyan_back=$'\e[48;2;17;168;205m'
white_back=$'\e[48;2;229;229;229m'
light_black_back=$'\e[48;2;102;102;102m'
light_red_back=$'\e[48;2;241;76;76m'
light_green_back=$'\e[48;2;35;209;139m'
light_yellow_back=$'\e[48;2;245;245;67m'
light_blue_back=$'\e[48;2;59;142;234m'
light_magenta_back=$'\e[48;2;214;112;214m'
light_cyan_back=$'\e[48;2;41;184;219m'
light_white_back=$'\e[48;2;229;229;229m'
...
headline_exit_meaning() { # (num)
	...
	case $1 in
		 53) echo 'Possibly Windows dll not found';; # `dll not found` on Windows throws error code: `0xC0000135`, I think error codes are 8 bit so `35` gets read and `35` in decimal is 53
...
headline_git_status() {
	...
	local raw lines
	#! If using WSL, these calls to `du` (and I think `headline_git status` also) are very slow if $PWD is on the windows filesystem (/mnt/c/**/). 
	#! Set `max` to ~30M if you are experiencing long downtimes between prompts.
	local max="500M" # 500 megabytes
...
headline_precmd() {
	...
	if [[ $HEADLINE_DO_CLOCK == 'true' ]]; then
		# RPROMPT='$(virtualenv_conda_prompt_info)%{$HEADLINE_STYLE_CLOCK%}$(date +$HEADLINE_CLOCK_FORMAT)%{$reset%}$HEADLINE_RPROMPT'
